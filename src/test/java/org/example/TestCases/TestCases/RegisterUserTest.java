...
public class RegisterUserTest {
    ...
    public void beforeSuite() {
        ...
        File testDir = new File(home, "test");   // Creates a File for <user.home>/test

        if (testDir.exists()) {
            System.out.println("Directory already exists: " + testDir.getAbsolutePath());
        } else if (testDir.mkdir()) {
            System.out.println("Directory successfully created: " + testDir.getAbsolutePath());
        } else {
            System.err.println("Failed to create directory: " + testDir.getAbsolutePath());
        }

        testDir = new File(home, "test/ss");   // Creates a File for <user.home>/test
...
//        //user.dir is the home directory of the user
...
//        extent.setSystemInfo("Test Status", "Pending");
...
//    }
    ...
    public void homepage(){
     //   extent.createTest("Verify that home page is visible successfully");
